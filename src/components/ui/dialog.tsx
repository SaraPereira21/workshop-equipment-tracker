...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("pr-8 text-base font-semibold leading-tight tracking-tight sm:text-lg", className)}
    {...props}
  />
));
